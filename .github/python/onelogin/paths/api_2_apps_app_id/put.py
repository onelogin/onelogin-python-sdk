...
# body param
SchemaForRequestBodyApplicationJson = GenericApp


request_body_generic_app = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GenericApp
...
class BaseApi(api_client.Api):
    ...
    def _update_app_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_generic_app.serialize(body, content_type)
