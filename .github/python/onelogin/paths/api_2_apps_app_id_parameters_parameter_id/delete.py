...
ParameterIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'app_id': typing.Union[AppIdSchema, decimal.Decimal, int, ],
        'parameter_id': typing.Union[ParameterIdSchema, str, ],
    }
)
...
request_path_parameter_id = api_client.PathParameter(
    name="parameter_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ParameterIdSchema,
    required=True,
)
_auth = [
    'OAuth2',
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_app_parameter_oapg(
        self,
...
class DeleteAppParameter(BaseApi):
    ...
    def delete_app_parameter(
        ...
        return self._delete_app_parameter_oapg(
