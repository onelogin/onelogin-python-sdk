...
# body param
SchemaForRequestBodyApplicationJson = AuthScope


request_body_auth_scope = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_scope_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_auth_scope.serialize(body, content_type)
