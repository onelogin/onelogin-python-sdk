...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "personal_email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "personal_email", ], str]):
...
class SendInviteLink(BaseApi):
    ...
    def send_invite_link(
        ...
        return self._send_invite_link_oapg(
            body=body,
