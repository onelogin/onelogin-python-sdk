...
# body param
SchemaForRequestBodyApplicationJson = RiskRule


request_body_risk_rule = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RiskRule
...
class BaseApi(api_client.Api):
    ...
    def _create_risk_rule_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_risk_rule.serialize(body, content_type)
...
class CreateRiskRule(BaseApi):
    ...
    def create_risk_rule(
        ...
        return self._create_risk_rule_oapg(
            body=body,
