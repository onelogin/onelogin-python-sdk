...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AuthServer']:
            return AuthServer

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AuthServer'], typing.List['AuthServer']],
    ...
    def __getitem__(self, i: int) -> 'AuthServer':
...
class ListAuthServers(BaseApi):
    ...
    def list_auth_servers(
        ...
        return self._list_auth_servers_oapg(
