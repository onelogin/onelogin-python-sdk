...
class SchemaFor200ResponseBodyApplcationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "icon_url", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "icon_url", ], str]):
...
class GetRoleApps(BaseApi):
    ...
    def get_role_apps(
        ...
        return self._get_role_apps_oapg(
