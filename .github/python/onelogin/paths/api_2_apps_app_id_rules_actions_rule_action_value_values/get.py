...
RuleActionValueSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'app_id': typing.Union[AppIdSchema, decimal.Decimal, int, ],
        'rule_action_value': typing.Union[RuleActionValueSchema, str, ],
    }
)
...
request_path_rule_action_value = api_client.PathParameter(
    name="rule_action_value",
    style=api_client.ParameterStyle.SIMPLE,
    schema=RuleActionValueSchema,
    required=True,
)
_auth = [
    'OAuth2',
...
class BaseApi(api_client.Api):
    ...
    def _list_action_valies_oapg(
        ...
        for parameter in (
            request_path_app_id,
            request_path_rule_action_value,
        ):
...
class ListActionValies(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_action_valies(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_action_valies(
        ...
        return self._list_action_valies_oapg(
