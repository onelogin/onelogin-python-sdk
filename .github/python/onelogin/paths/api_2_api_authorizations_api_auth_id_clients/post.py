...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["app_id", "scopes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["app_id", "scopes", ], str]):
...
class AddClientApp(BaseApi):
    ...
    def add_client_app(
        ...
        return self._add_client_app_oapg(
            body=body,
