...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["verb", "ip", "user_agent", "user", "source", "session", "device", "fp", "published", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["verb", "ip", "user_agent", "user", "source", "session", "device", "fp", "published", ], str]):
...
class TrackRiskEvent(BaseApi):
    ...
    def track_risk_event(
        ...
        return self._track_risk_event_oapg(
            body=body,
