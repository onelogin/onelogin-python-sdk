...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["state_token", "otp_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["state_token", "otp_token", ], str]):
...
class VerifyMfaFactor(BaseApi):
    ...
    def verify_mfa_factor(
        ...
        return self._verify_mfa_factor_oapg(
            body=body,
