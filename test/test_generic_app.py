...
import onelogin
from onelogin.models.generic_app import GenericApp  # noqa: E501
from onelogin.rest import ApiException

class TestGenericApp(unittest.TestCase):
    """GenericApp unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `GenericApp`
        """
        model = onelogin.models.generic_app.GenericApp()  # noqa: E501
        if include_optional :
            return GenericApp(
                id = 775664, 
                name = 'A Sample App', 
