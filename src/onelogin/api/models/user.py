...
class User(object):
    def __init__(self, data):
        ...
        self.distinguished_name = data.get('distinguished_name', None)
        self.phone = data.get('phone', None)
        self.company = data.get('company', None)
        self.department = data.get('department', None)
        self.status = data.get('status', None)
        self.member_of = data.get('member_of', None)
        self.samaccountname = data.get('samaccountname', None)
        self.userprincipalname = data.get('userprincipalname', None)
        ...
        self.openid_name = data.get('openid_name', None)
        self.locale_code = data.get('locale_code', None)
