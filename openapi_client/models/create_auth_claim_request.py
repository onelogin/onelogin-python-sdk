...
class CreateAuthClaimRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAuthClaimRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAuthClaimRequest:
        """Create an instance of CreateAuthClaimRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateAuthClaimRequest.parse_obj(obj)

        _obj = CreateAuthClaimRequest.parse_obj({
            "name": obj.get("name"),
