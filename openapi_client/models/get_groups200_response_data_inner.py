...
class GetGroups200ResponseDataInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetGroups200ResponseDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetGroups200ResponseDataInner:
        """Create an instance of GetGroups200ResponseDataInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetGroups200ResponseDataInner.parse_obj(obj)

        _obj = GetGroups200ResponseDataInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
