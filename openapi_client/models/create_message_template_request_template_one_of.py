...
class CreateMessageTemplateRequestTemplateOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMessageTemplateRequestTemplateOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMessageTemplateRequestTemplateOneOf:
        """Create an instance of CreateMessageTemplateRequestTemplateOneOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateMessageTemplateRequestTemplateOneOf.parse_obj(obj)

        _obj = CreateMessageTemplateRequestTemplateOneOf.parse_obj({
