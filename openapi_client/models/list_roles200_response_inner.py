...
class ListRoles200ResponseInner(BaseModel):
    ...
    admins: Optional[List[StrictInt]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRoles200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRoles200ResponseInner:
        """Create an instance of ListRoles200ResponseInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListRoles200ResponseInner.parse_obj(obj)

        _obj = ListRoles200ResponseInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "apps": obj.get("apps"),
            "users": obj.get("users"),
