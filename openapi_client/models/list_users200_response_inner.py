...
class ListUsers200ResponseInner(BaseModel):
    ...
    samaccount_name: Optional[StrictStr] = Field(None, description="The user's Active Directory username.")
    ...
    def state_validate_enum(cls, v):
        ...
        if v not in (0, 1, 2, 3):
            raise ValueError("must validate the enum values (0, 1, 2, 3)")
        return v
    ...
    def status_validate_enum(cls, v):
        ...
        if v not in (0, 1, 2, 3, 4, 5, 7, 8):
            raise ValueError("must validate the enum values (0, 1, 2, 3, 4, 5, 7, 8)")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListUsers200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListUsers200ResponseInner:
        """Create an instance of ListUsers200ResponseInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListUsers200ResponseInner.parse_obj(obj)

        _obj = ListUsers200ResponseInner.parse_obj({
            "id": obj.get("id"),
            ...
            "samaccount_name": obj.get("samaccount_name"),
