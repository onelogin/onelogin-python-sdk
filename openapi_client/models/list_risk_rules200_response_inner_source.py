...
class ListRiskRules200ResponseInnerSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRiskRules200ResponseInnerSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRiskRules200ResponseInnerSource:
        """Create an instance of ListRiskRules200ResponseInnerSource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListRiskRules200ResponseInnerSource.parse_obj(obj)

        _obj = ListRiskRules200ResponseInnerSource.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
