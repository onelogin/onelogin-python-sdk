...
class ListPriveleges200ResponseInnerPrivilegeStatementInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPriveleges200ResponseInnerPrivilegeStatementInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPriveleges200ResponseInnerPrivilegeStatementInner:
        """Create an instance of ListPriveleges200ResponseInnerPrivilegeStatementInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListPriveleges200ResponseInnerPrivilegeStatementInner.parse_obj(obj)

        _obj = ListPriveleges200ResponseInnerPrivilegeStatementInner.parse_obj({
