...
class GetEventById200Response(BaseModel):
    ...
    """
    status: Optional[GetEventById200ResponseStatus] = None
    data: Optional[GetEvents200ResponseDataInner] = None
    ...
    def from_dict(cls, obj: dict) -> GetEventById200Response:
        ...
        _obj = GetEventById200Response.parse_obj({
            "status": GetEventById200ResponseStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None,
            "data": GetEvents200ResponseDataInner.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
