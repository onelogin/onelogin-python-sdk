...
class GenerateToken200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateToken200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateToken200Response:
        """Create an instance of GenerateToken200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GenerateToken200Response.parse_obj(obj)

        _obj = GenerateToken200Response.parse_obj({
