...
class SsoSamlAllOf(BaseModel):
    ...
    certificate: Optional[SsoSamlAllOfCertificate] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SsoSamlAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SsoSamlAllOf:
        """Create an instance of SsoSamlAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SsoSamlAllOf.parse_obj(obj)

        _obj = SsoSamlAllOf.parse_obj({
            "metadata_url": obj.get("metadata_url"),
            "acs_url": obj.get("acs_url"),
            "sls_url": obj.get("sls_url"),
            "issuer": obj.get("issuer"),
            "certificate": SsoSamlAllOfCertificate.from_dict(obj.get("certificate")) if obj.get("certificate") is not None else None
        })
        return _obj
