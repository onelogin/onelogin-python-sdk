...
class ListMappings200ResponseInnerActionsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMappings200ResponseInnerActionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMappings200ResponseInnerActionsInner:
        """Create an instance of ListMappings200ResponseInnerActionsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListMappings200ResponseInnerActionsInner.parse_obj(obj)

        _obj = ListMappings200ResponseInnerActionsInner.parse_obj({
