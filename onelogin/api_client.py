...
from onelogin.exceptions import ApiTypeError, ApiValueError, ApiException
from onelogin.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/3.0.0-alpha.1/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.activate_factor  # this is an instance of the class Endpoint
        api_instance.activate_factor()  # this invokes api_instance.activate_factor.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.activate_factor.callable or self.callable in this class
