...
class GenerateSamlAssertionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username_or_email, password, app_id, subdomain, *args, **kwargs):  # noqa: E501
        """GenerateSamlAssertionRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ip_address (str): Whitelisted IP address, if MFA is required and you need to honor IP address whitelisting defined in MFA policies.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, username_or_email, password, app_id, subdomain, *args, **kwargs):  # noqa: E501
        """GenerateSamlAssertionRequest - a model defined in OpenAPI
