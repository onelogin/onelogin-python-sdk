...
class Mapping(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, enabled, match, position, actions, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            actions ([Action]): An array of actions that will be applied to the users that are matched by the conditions.
        ...
        Keyword Args:
            ...
            conditions ([Condition]): An array of conditions that the user must meet in order for the mapping to be applied.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, enabled, match, position, actions, *args, **kwargs):  # noqa: E501
        """Mapping - a model defined in OpenAPI
