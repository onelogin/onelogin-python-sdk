...
class GetRiskScoreRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ip, user_agent, user, *args, **kwargs):  # noqa: E501
        """GetRiskScoreRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, ip, user_agent, user, *args, **kwargs):  # noqa: E501
        """GetRiskScoreRequest - a model defined in OpenAPI
