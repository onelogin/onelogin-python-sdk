...
# body param
SchemaForRequestBodyApplicationJson = AppRule


request_body_app_rule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AppRule
...
class BaseApi(api_client.Api):
    ...
    def _update_app_rule_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_app_rule.serialize(body, content_type)
...
class UpdateAppRule(BaseApi):
    ...
    def update_app_rule(
        ...
        return self._update_app_rule_oapg(
            body=body,
