...
# body param
SchemaForRequestBodyApplicationJson = RequestBrand


request_body_request_brand = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Brand
...
class BaseApi(api_client.Api):
    ...
    def _update_brand_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_request_brand.serialize(body, content_type)
