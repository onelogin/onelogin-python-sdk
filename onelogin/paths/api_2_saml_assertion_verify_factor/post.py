...
# body param
SchemaForRequestBodyApplicationJson = SamlFactor


request_body_saml_factor = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ver_factor_saml2_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_saml_factor.serialize(body, content_type)
...
class VerFactorSaml2(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def ver_factor_saml2(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def ver_factor_saml2(
        ...
        return self._ver_factor_saml2_oapg(
            body=body,
