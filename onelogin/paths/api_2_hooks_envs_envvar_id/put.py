...
# Path params
EnvvarIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'envvar_id': typing.Union[EnvvarIdSchema, str, ],
    }
)
...
request_path_envvar_id = api_client.PathParameter(
    name="envvar_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EnvvarIdSchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = HookEnvvar
...
SchemaFor400ResponseBodyApplicationJson = AltErr
...
SchemaFor422ResponseBodyApplicationJson = HookStatus
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_environment_variable_oapg(
        self,
...
class UpdateEnvironmentVariable(BaseApi):
    ...
    def update_environment_variable(
        ...
        return self._update_environment_variable_oapg(
            body=body,
