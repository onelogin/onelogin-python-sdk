...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TokenClaim']:
            return TokenClaim

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['TokenClaim'], typing.List['TokenClaim']],
    ...
    def __getitem__(self, i: int) -> 'TokenClaim':
...
class GetAuthclaims(BaseApi):
    ...
    def get_authclaims(
        ...
        return self._get_authclaims_oapg(
