...
RoleNameSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'role_name': typing.Union[RoleNameSchema, str, ],
        'app_id': typing.Union[AppIdSchema, decimal.Decimal, int, ],
        'app_name': typing.Union[AppNameSchema, str, ],
...
request_query_role_name = api_client.QueryParameter(
    name="role_name",
    style=api_client.ParameterStyle.FORM,
