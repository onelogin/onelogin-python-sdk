...
# body param
SchemaForRequestBodyApplicationJson = SamlAssert


request_body_saml_assert = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_saml_assert2_oapg(
        self,
    ...
    def _generate_saml_assert2_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_saml_assert.serialize(body, content_type)
...
class GenerateSamlAssert2(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def generate_saml_assert2(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def generate_saml_assert2(
        ...
        return self._generate_saml_assert2_oapg(
            body=body,
