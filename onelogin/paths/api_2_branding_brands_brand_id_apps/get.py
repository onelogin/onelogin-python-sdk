...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BrandApp']:
            return BrandApp

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['BrandApp'], typing.List['BrandApp']],
    ...
    def __getitem__(self, i: int) -> 'BrandApp':
...
class GetBrandApps(BaseApi):
    ...
    def get_brand_apps(
        ...
        return self._get_brand_apps_oapg(
