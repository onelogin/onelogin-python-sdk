...
CorrelationIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'correlation_id': typing.Union[CorrelationIdSchema, str, ],
    },
    total=False
)
...
request_query_correlation_id = api_client.QueryParameter(
    name="correlation_id",
    style=api_client.ParameterStyle.FORM,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['HookLog'], typing.List['HookLog']],
        _configuration: typing.Optional[schemas.Configuration] = None,
