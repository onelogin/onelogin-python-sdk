...
SchemaFor200ResponseBodyApplicationJson = RuleCondition
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_condition_values_oapg(
        self,
...
class ListConditionValues(BaseApi):
    ...
    def list_condition_values(
        ...
        return self._list_condition_values_oapg(
