...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_id", "user_display_name", "type_display_name", "auth_factor_name", "default", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_id", "user_display_name", "type_display_name", "auth_factor_name", "default", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_authentication_devices_oapg(
        self,
...
class GetAuthenticationDevices(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_authentication_devices(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_authentication_devices(
        ...
        return self._get_authentication_devices_oapg(
