...
# body param
SchemaForRequestBodyApplicationJson = MessageTemplate


request_body_message_template = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_message_template_oapg(
        self,
    ...
    def _create_message_template_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_message_template.serialize(body, content_type)
...
class CreateMessageTemplate(BaseApi):
    ...
    def create_message_template(
        ...
        return self._create_message_template_oapg(
            body=body,
